...
<head>
    ...
    <title>Login Page - Seov Wedding</title>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="email" name="email"
                                            placeholder="Masukkan email anda" aria-describedby="email" tabindex="1"
                                            autofocus />
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge"
                                                id="password-confirm" name="password_confirmation" tabindex="2"
                                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                aria-describedby="password" />
                                            <span class="input-group-text cursor-pointer"><i
                                                    data-feather="eye"></i></span>
